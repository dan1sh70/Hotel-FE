...
export default function SrirangamRooms() {
  ...
  return (
    <div className="min-h-screen bg-[#f9e4c8]">
      {/* Header */}
      <div className="bg-[#f6d68e] px-6 py-4 border-b border-gray-200">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-xs">
              ...
              <div 
                className={`w-10 h-5 rounded-full cursor-pointer transition-colors ${showSharing ? 'bg-red-500' : 'bg-gray-300'}`}
            ...
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Search"
                className="pl-9 pr-3 py-1.5 border border-gray-300 rounded-lg text-xs"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 mt-3 max-w-7xl mx-auto text-xs">
          <button className="px-3 py-1.5 bg-white rounded-full border border-gray-300">💰 Price</button>
          <button className="px-3 py-1.5 bg-white rounded-full border border-gray-300">❄️ Ac/Non-Ac</button>
          <button className="px-3 py-1.5 bg-white rounded-full border border-gray-300">👤 Single</button>
          <button className="px-3 py-1.5 bg-white rounded-full border border-gray-300">⚙️ More</button>
      ...
      <div className="flex max-w-7xl mx-auto">
                ...
                <div className="flex-1 p-3">
                  <div className="flex justify-between items-start mb-1.5">
                    ...
                    <div className="text-right">
                      <div className="text-lg font-bold text-gray-800">₹{listing.price.toLocaleString()}</div>
        ...
        <div className="w-1/2 p-5">
          <div className="bg-white rounded-xl h-full relative overflow-hidden shadow-sm border border-gray-200">
            <iframe
