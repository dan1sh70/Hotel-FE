...
function RegistrationDetails({ address = { street: '', city: '', state: '', postalCode: '' }, setAddress }) {
        ...
        <div className="bg-gray-50 shadow-lg rounded-xl p-8 mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                <input
                    ...
                    className="bg-white rounded-lg p-2 shadow-2xl w-full"
                />
                <input
                    type="text"
                    placeholder="City"
                    ...
                    className="bg-white rounded-lg p-2 w-full shadow-2xl"
                />
                <input
                    type="text"
                    placeholder="State"
