...
const TempleBooking = () => {
  return (
    <div className="relative min-h-screen bg-cover bg-center bg-no-repeat" 
         style={{
           backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('YOUR_TEMPLE_IMAGE_URL_HERE')`
         }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        {/* Search Form */}
        <div className="bg-white rounded-lg shadow-2xl p-4 w-full max-w-5xl">
          <div className="flex flex-row items-center gap-2">
            ...
            <button className="flex items-center gap-2 px-4 py-3 cursor-pointer">
            ...
            {/* Book Now Button */}
            <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors text-sm ml-2">
              BOOK NOW
            </button>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="flex items-center justify-center gap-4 flex-nowrap">
            ...
            <button className="bg-gray-500 bg-opacity-40 hover:bg-opacity-60 text-white px-4 py-2 rounded-full transition-all duration-300 backdrop-blur-md whitespace-nowrap">
              Srirangam
            </button>
            <button className="bg-gray-500 bg-opacity-40 hover:bg-opacity-60 text-white px-4 py-2 rounded-full transition-all duration-300 backdrop-blur-md whitespace-nowrap">
              Malai Kottai
